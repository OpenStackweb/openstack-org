    ...
    <div class="container inner-software" role="tabpanel" id="overview">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <p>&nbsp; </p>
                <p>
                    <img class="openstack-map" width="100%" src="https://object-storage-ca-ymq-1.vexxhost.net/swift/v1/6e4619c416ff4bd19e1c087f27a43eea/www-assets-prod/openstack-map-v20230501.png" onerror="this.onerror=null; this.src=assets/openstack-map/openstack-map-v20210201.svg" alt="OpenStack Cloud landscape map">
                </p>
            </div>
            <p>&nbsp; </p>
        </div>
