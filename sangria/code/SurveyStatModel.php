...
class SurveyStatModel
{
     ...
     */
    public function getQuestionFilters($matchClass, $tablePrefix = 'I', $matchID = 'ID')
    {
...
SQL;
    ...
    public function getMandatoryAnswersFilter($matchClass) {
        ...
        (
            ...
            WHERE S.ID = {$compareId} AND Q.Mandatory = 1
        )
SQL;
