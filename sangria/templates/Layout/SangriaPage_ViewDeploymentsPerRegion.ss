...
<% include SangriaPage_SurveyRangeSelector Type='SurveyEntity', Label='Select version of deployment', FormAction=$Top.Link(ViewDeploymentsPerRegion), FromPage=ViewDeploymentsPerRegion, UseSurveyBuilder=1 %>
