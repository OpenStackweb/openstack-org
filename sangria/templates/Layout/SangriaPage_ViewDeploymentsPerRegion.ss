...
<% include SangriaPage_SurveyRangeSelector Label='Select version of deployment', FormAction=$Top.Link(ViewDeploymentsPerRegion), FromPage=ViewDeploymentsPerRegion, UseSurveyBuilder=1 %>
