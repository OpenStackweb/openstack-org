<style>
    .hero-survey {
        ...
        background-image: url('https://object-storage-ca-ymq-1.vexxhost.net/swift/v1/6e4619c416ff4bd19e1c087f27a43eea/www-assets-prod/learn/UserSurvey-hero.jpg');
...
<div class="container">
    ...
    <% end_if %>
    <p>
        $_T("survey_ui", "This survey provides users an opportunity to influence the community and software direction. By sharing information about your configuration and requirements, the Open Infrastructure Foundation Technical Committee will be able to advocate on your behalf. Take the OpenStack User Survey by %1$s to be included in this round of analysis.", "Friday, August 28, 2026")
    </p>
