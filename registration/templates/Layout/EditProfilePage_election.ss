	...
	<h1>$Title</h1>
		...
		<% if FoundationMember %>
			...
			<% if NominationsForCurrentMember %>
                ...
                <% loop NominationsForCurrentMember %>
                    <% if Last %>
			...
			<p><a href="{$Link}CandidateList/" class="roundedButton">See The Current Nominations</a> &nbsp; <a href="/community/members/" class="roundedButton">Nominate A Member</a></p>
			</fieldset></form>
