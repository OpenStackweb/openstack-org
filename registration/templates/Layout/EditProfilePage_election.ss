	...
	<% require themedCSS(profile-section) %>
        ...
        <% if CurrentMember.isFoundationMember %>
                ...
                <% if not NominationsAreOpen %>
                    ...
                    <p>Nominations are currently closed. Elections start {$ElectionsOpen.Day}, {$ElectionsOpen.Month} {$ElectionsOpen.DayOfMonth}, {$ElectionsOpen.Year}. See the <a href="$Link">Election Details</a>.</p>
                    
                    <p>If you are a Gold Memember Candidate, you can still edit your <a class="roundedButton" href="{$Top.Link}CandidateApplication/">Candidate Profile</a>. </p>
				...
				<p><a href="/election/2015-individual-director-election/CandidateList/" class="roundedButton">See The Current Nominations</a> &nbsp; 
