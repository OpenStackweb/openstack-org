<div class="container">
    ...
    <% if CurrentMember %>
        ...
        <p>Are you sure you want to resign your membership to the Open Infrastructure Foundation? This action will <strong>completely
            remove your account</strong> and cannot be undone.</p>

        <p><a href="{$Top.Link}resign/?confirmed=1" class="roundedButton">Yes, I want to resign</a> &nbsp; <a
