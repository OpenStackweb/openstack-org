 ...
 **/
class MemberLegacyMembersMigration extends AbstractDBMigrationTask
{
    protected $title = "MemberLegacyMembersMigration";

    protected $description = "MemberLegacyMembersMigration";
