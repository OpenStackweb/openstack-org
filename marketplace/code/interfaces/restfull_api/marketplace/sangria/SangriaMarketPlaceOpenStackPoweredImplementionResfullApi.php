        ...
        try
        {
            ...
            foreach ($list as $item){
                ...
                [
                    ...
                    'required_for_dns'           => boolval($item->CompatibleWithDNS),
                    'required_for_orchestration' => boolval($item->CompatibleWithOrchestration),
                    'required_for_storage' => boolval($item->CompatibleWithStorage),
                    'required_for_shared_file_system' => boolval($item->CompatibleWithSharedFileSystem),
                    'required_for_platform' => boolval($item->CompatibleWithPlatform),
                    'federated_identity'   => boolval($item->CompatibleWithFederatedIdentity),
                    'uses_ironic'          => boolval($item->UsesIronic),
        ...
        foreach ($list as $item){
            ...
            $data[] =
                [
                    ...
                    'Required For DNS' => intval($item->CompatibleWithDNS),
                    'Required For Orchestration' => intval($item->CompatibleWithOrchestration),
                    'Required For Shared File System' => intval($item->CompatibleWithSharedFileSystem),
                    'Required For Platform' => boolval($item->CompatibleWithPlatform),
                    'Federated Identity'   => intval($item->CompatibleWithFederatedIdentity),
                    'Ironic'               => intval($item->UsesIronic),
