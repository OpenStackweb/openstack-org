...
final class TrainingFacade
{
    ...
    public function getTrainings($topic = "", $location = "", $level = "", $limit = true)
    {
        ...
        foreach ($active_training as $t) {
            ...
            $courses_dto = $this->course_repository->get($t->getIdentifier(), DateTimeUtils::getCurrentDate(), $topic,
                $location, $level, $limit);
            if (!count($courses_dto)) {
                continue;
            }
    ...
    {
        $res = new ArrayList();
        $courses_dto = $this->course_repository->getFilteredClasses(DateTimeUtils::getCurrentDate(), $location, $level,
    ...
    public function getCompanyTraining($training_id, $company_url_segment)
    {
        ...
        foreach ($courses as $course) {
            ...
            $locations_dto = $this->course_repository->getLocationsByDate($course->getIdentifier(),
                DateTimeUtils::getCurrentDate());
