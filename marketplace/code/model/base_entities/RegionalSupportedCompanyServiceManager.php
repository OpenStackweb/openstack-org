...
abstract class RegionalSupportedCompanyServiceManager extends CompanyServiceManager
{
    ...
    {
        $regional_supported_company_service = parent::clearCollections($regional_supported_company_service);
        $regional_supported_company_service->clearRegionalSupports();

        return $regional_supported_company_service;
    }

    protected function updateCollections(ICompanyService $regional_supported_company_service, array $data)
    {
        $regional_supported_company_service = parent::updateCollections($regional_supported_company_service, $data);
    ...
    protected function addRegionalSupport(
        array $regional_support_data,
        IRegionalSupportedCompanyService $regional_supported_company_service
    ) {
