...
/**
 * Class CustomerCaseStudyDraft
 */
class CustomerCaseStudyDraft extends DataObject implements ICustomerCaseStudy {
    ...
    public function getOwner()
    {
        ...
        return AssociationFactory::getInstance()->getMany2OneAssociation($this,'Owner','CustomerCaseStudies',$query)->getTarget();
    }
    ...
    public function setOwner(ICompanyService $new_owner)
    {
        $query = new QueryObject($this);
        $query->addOrder(QueryOrder::asc('Order'));
        AssociationFactory::getInstance()->getMany2OneAssociation($this,'Owner','CustomerCaseStudies',$query)->setTarget($new_owner);
    }
    /**
     * @return int
     */
