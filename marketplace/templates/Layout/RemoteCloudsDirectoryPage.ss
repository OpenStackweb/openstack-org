...
<div class="container">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4">
        ...
        <div class="add-your-course">
            <p>
                Does your company offer remotely managed private clouds for OpenStack? Be listed here!<a href="mailto:ecosystem@openstack.org">Email us for details</a> or <a href="https://calendar.x.ai/jimmymcarthur-720/default">put some time on our calendar</a> to meet remotely.
            </p>
        </div>
    </div>
</div>
