    ...
    <div class="training-program-box" style="border-left-color: #{$Company.CompanyColor}">
        <div class="row">
            <div class="col-lg-6">
                <div class="logo-area">
                    ...
                    <a href="{$Top.TrainingLink}{$Company.URLSegment}/{$ID}" >
            ...
            <div class="col-lg-6">
                <div class="company-details-area">
                    <h1>
                        <a href="{$Top.TrainingLink}{$Company.URLSegment}/{$ID}" style="color: #{$Company.CompanyColor}">$ProgramName</a>
                    </h1>
                    <div>$Description</div>
                </div>
            </div>
        ...
        <div class="span-17 last">
            <div class="course-area">
                ...
                <a style="background-color: #{$Company.CompanyColor}" href="{$Top.TrainingLink}{$Company.URLSegment}/{$ID}" class="details-button">Details</a>
