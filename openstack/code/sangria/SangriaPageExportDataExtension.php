        ...
        if($extra_data) {
            switch($extra_data) {
                ...
                case 'affiliates' :
                    ...
                    $org_fields = array('Org.Name','Org.ID','Member.ID','Member.FirstName','Member.Surname','Affiliation.Current','Affiliation.JobTitle');
                    $query->setSelect($org_fields);
                    break;
                case 'deployments' :
                    $query->setFrom('Org');
                    $query->addLeftJoin('Deployment', 'Deployment.OrgID = Org.ID');
                    $org_fields = array('Org.Name','Org.ID','Deployment.Created','Deployment.LastEdited','Deployment.Label','Deployment.IsPublic');
                    $query->setSelect($org_fields);
                ...
                case 'deployment_surveys' :
                    ...
                    $org_fields = array('Org.Name','Org.ID','DeploymentSurvey.Created','DeploymentSurvey.LastEdited','DeploymentSurvey.Title');
                ...
                case 'speakers' :
                    ...
                    $org_fields = array('Org.Name','Org.ID','PresentationSpeaker.FirstName','PresentationSpeaker.LastName','Summit.Name');
                    $query->setSelect($org_fields);
                    break;
            }
        }
