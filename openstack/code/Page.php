...
class Page extends SiteTree {
	...
	function getCMSFields() {
	     ...
	     $fields->addFieldToTab('Root.Metadata', new TextField ('PageCSS','Custom CSS File For This Page (must be in CSS directory)'));
	     
		 $fields->addFieldToTab('Root.Metadata', new CheckboxField ('IncludeJquery','Include JQuery In This Page'));
		 
		 $fields->addFieldToTab('Root.Metadata', new CheckboxField ('IncludeShadowBox','Include ShadowBox Javascript and CSS'));
		
		 $fields->addFieldToTab('Root.Metadata', new TextareaField ('PageJavaScript','Custom JavaScript For This Page'));
