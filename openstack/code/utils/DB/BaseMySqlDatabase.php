 ...
 **/
class BaseMySQLDatabase extends SS_Database {
    /**
    ...
    public function __construct($parameters) {
        ...
        $config_sql_mode = Config::inst()->get(get_class($this), 'sql_mode');
        if(!empty($config_sql_mode))
            $this->sql_mode = $config_sql_mode;

        $this->query(sprintf("SET sql_mode = '%s'", $this->sql_mode));
