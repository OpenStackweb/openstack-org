...
class UserCommitteePage extends Page{
...
class UserCommitteePage_Controller extends  Page_Controller{

    public function UserCommitteeMembers(){
        //Group_Member
        $group = Group::get()->filter('Code','user-committee')->first();
