...
<head>
    ...
    <title>OpenStack Summit | About The Summit | OpenStack Summit</title>
...
<body>
    <div class="main-body">
        <div id="wrap">
            <div class="summit-hero-wrapper austin ">
                <div class="container">
                    <div class="row">
    ...
    <div class="container">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4">
            <ul class="help-me-menu">
                ...
                <!-- <li><a href="#"><i class="fa fa-comment"></i>Become a Speaker</a></li> -->
...
<div class="white networking-row">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-push-2">
                <h1>Knowledge, Nightlife, &amp; New Friends.</h1>
                <p>
