...
<div class="intro-header legacy">
                                   ...
                                   <div class="col-sm-7 link-back">
                                    ...
                                    <div class="col-sm-5">
                                        <ul class="list-inline filters">
                                            <li>
                                                <i class="fa fa-database fa-2x"></i><span>Integration</span>
                                            </li>
                                            <li>
    ...
    <div class="content-section-a steps-section">
        ...
        <div class="container">
            <div class="row section-title-center">
                <h4 class="above">VMWare with OpenStack</h4>
                <h1>Three Reference Architectures for VMware and OpenStack</h1>
            </div>
            <!--Method 1-->
            <div class="row">
                <div class="col-sm-6">
                    <h2 class="section-heading"><span class="count">1</span>Multi-Hypervisor Environment</h2>
                    <p class="lead">Running Both vSphere and Alternate Hypervisors</p>
                    <p>
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-push-6">
                    <h2 class="section-heading"><span class="count">2</span>Commercial Distributions</h2>
                    <p class="lead">VMware Technologies Through Commercial OpenStack distributions</p>
                    <p>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h2 class="section-heading"><span class="count">3</span>VIO</h2>
                    <p class="lead">VMware Integrated OpenStack</p>
                    <p>
                    ...
                    <p>
                        <a href="{$Top.CloudUrl('assets/pdf-downloads/adobe-dm-case-study.pdf')}">Read the Adobe Digital Marketing case study.</a>
                    </p>
                </div>
                <div class="col-sm-6">
                    <div class="thumbnails" data-toggle="lightbox">
    ...
    <div class="content-section-a action-wrapper white">
        <div class="container">
            <div class="row">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p class="download-text">
                ...
                <a href="{$Top.CloudUrl('assets/pdf-downloads/virtualization-Integration-whitepaper-2015.pdf')}" class="download-btn"><i class="fa fa-arrow-circle-down fa-2x"></i> Download This White Paper</a>
            <hr>
            <p>
    ...
    <!-- Video 1 Modal -->
    <div class="modal fade" id="VideoModalVMWare1">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
          ...
          <div class="modal-body">
            <p class="download-text">
                ...
                <iframe width="100%" height="315" src="//www.youtube.com/embed/3WqFTPgNRGg?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
          </div>
          <div class="modal-footer">
          </div>
        </div><!-- /.modal-content -->
    ...
    <!-- Video 2 Modal -->
    <div class="modal fade" id="VideoModalVMWare">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
          ...
          <div class="modal-body">
            <p class="download-text">
                ...
                <iframe width="560" height="315" src="//www.youtube.com/embed/syGmDYfzx5Q?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
          </div>
          <div class="modal-footer">
          </div>
        </div><!-- /.modal-content -->
    ...
    <!-- Video 3 Modal -->
    <div class="modal fade" id="VideoModalVMWare2">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
          ...
          <div class="modal-body">
            <p class="download-text">
                ...
                <iframe width="560" height="315" src="//www.youtube.com/embed/OetUfBkfO1M" frameborder="0" allowfullscreen></iframe>
          </div>
          <div class="modal-footer">
          </div>
        </div><!-- /.modal-content -->
