    ...
    <!-- Begin Page Content -->
        <div class="intro-header security">
        <div class="container">
        ...
        <a href="https://flic.kr/p/cmLNAA" class="photo-credit" data-toggle="tooltip" data-placement="left" title="Photo by Mark Fischer" target="_blank"><i class="fa fa-info-circle"></i></a>
        <!-- /.container -->
                   ...
                   <div class="col-xs-7 link-back">
                    ...
                    <div class="col-xs-5">
                        <ul class="list-inline filters">
                            <li>
                                <i class="fa fa-database fa-2x"></i><span>Security</span>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 center">
                    <h1>OpenStack provides peace of mind</h1>
                </div>
            </div>
            <div class="row">
...
<div class="badge-promo-row">
        <div class="container">
            <div class="row">
                <div class="col-sm-10 col-sm-push-1">
                    <h2>
                        OpenStack awarded the<br>Core Infrastructure Initiative Best Practices badge
                    </h2>
                    <p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-10 col-sm-push-1 center">
                    <h1>Security is a multi-stakeholder effort backed by the vigilant OpenStack Security Team</h1>
                    <p>
            ...
            <div class="row">
                <div class="col-lg-8 col-sm-push-2">
                    <div class="security-action-wrapper">
                        ...
                        <a class="security-action-btn" href="#" data-toggle="modal" data-target="#downloadModal"><i class="fa fa-arrow-circle-down"></i> Download The Report</a>
                    </div>
                </div>
            </div>
        </div> 
    ...
    <div class="content-section-c featured-wrapper security">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div id="mc_embed_signup">
                <form action="//openstack.us1.list-manage.com/subscribe/post?u=d7c523fd1a0dd18c4ccfcc508&amp;id=092d3d4637" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                    <div class="mc-field-group form-group">
                        ...
                        <p>
                            Get up to date info about OpenStack and future white papers.
                        </p>
