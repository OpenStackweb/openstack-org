    ...
    <div class="edge-why-openstack">
        <div class="container">
            <div class="row">
                <div class="col-sm-4 edge-icons-wrapper">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="resource-title-wrapper">
                        <span class="line"></span>
                        <h4 class="edge-resource-title">Articles</h4>
                        <span class="line"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="resource-title-wrapper">
                        <span class="line"></span>
                        <h4 class="edge-resource-title">OpenStack collaborates with other EDGE Groups</h4>
                        <span class="line"></span>
                    </div>
                </div>
            </div>
    ...
    <div class="edge-working-group">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="cta">
                        <a href="https://wiki.openstack.org/wiki/Fog_Edge_Massively_Distributed_Clouds" class="wg-btn" target="_blank">
                            More Info
                            <i class="fa fa-chevron-right" aria-hidden="true"></i>
                        </a>
                    </div>
