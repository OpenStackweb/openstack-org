    ...
    <section class="vmwmigration vmwmigration-ecosystem">
        <div class="container">
            ...
            <div class="row logos">
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="img-wrapper">
                        <img src="https://object-storage-ca-ymq-1.vexxhost.net/swift/v1/6e4619c416ff4bd19e1c087f27a43eea/www-assets-prod/companies/main_logo/easystack-lg2.jpg" alt="EasyStack logo">
                    </div>
                </div>
                <div class="col-sm-3 col-xs-6">
                    <div class="img-wrapper">
