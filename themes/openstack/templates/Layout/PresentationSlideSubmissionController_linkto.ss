<div class="container">
    ...
    <% else %>
        ...
        <h2 class="upload-tabs">
                <a href="$Link('upload')">Upload a file</a>
                <a href="$Link('linkto')" class="active">Link to an online presentation</a>
        </h2>
    ...
    <p></p>
    <hr/>
    <p>If you have any problems with this form, please contact <a href="mailto:events@openstack.org">events@openstack.org</a>
