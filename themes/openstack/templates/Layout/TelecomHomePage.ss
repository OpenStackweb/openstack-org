...
<div class="intro-header nfv">
        ...
        <a href="https://flic.kr/p/mszNvs" class="photo-credit" data-toggle="tooltip" data-placement="left" title="Photo by Kevin" target="_blank"><i class="fa fa-info-circle"></i></a>
    </div>
    <!-- /.intro-header -->
    ...
    <div class="content-section-a why-ues-wrapper nfv">
        <div class="container">
            <div class="row section-title-center">
                <div class="col-sm-12">
                    <h1>Why Global Communications companies are choosing OpenStack</h1>
                </div>
            </div>
            <div class="row enterprise-why-icons appdev">
                <div class="col-sm-4">
                    <div><i class="fa fa-random"></i></div>
                    <h3>Network agility</h3>
                    <p>
                        offers greater flexibility, scalability and resiliency
                    </p>
                </div>
                <div class="col-sm-4">
                    ...
                    <h3>Cost Savings</h3>
                    <p>
                        both on installation and management
                    </p>
                </div>
                <div class="col-sm-4">
                    <div><i class="fa fa-check"></i></div>
                    <h3>Proven implementation</h3>
                    <p>
                        by the world’s leading telecommunications companies
                    </p>
                </div>
                <div class="col-sm-4 col-sm-push-2">
                    ...
                    <p>
                        through ETSI and OPNFV, including reference architecture
                    </p>
                </div>
                <div class="col-sm-4 col-sm-push-2">
                    ...
                    <p>
                        industry-leading solutions are based on OpenStack
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="testimonial-row appdev nfv">
        <div class="container"> 
            <div class="row">
                <div class="col-lg-8 col-lg-push-2">
                    <blockquote>
                        Millions of AT&T wireless subscribers are connected to virtualized network services ... based on OpenStack.
                    </blockquote>
                    <div class="testimonial-attribute">
                        <div class="testimonial-name">— John Donovan<br>Senior Executive Vice President of Technology and Network Operations<br><strong>AT&T</strong></div>
                    </div>
                    <a href="http://www.theregister.co.uk/2016/01/08/att_expanding_sdn/" class="testimonial-link" target="_blank">Read more about how AT&T uses OpenStack</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content-section-c featured-wrapper nfv">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Learn more about NFV directly from users</h2>
                </div>
            </div>
            <div class="row">
               ...
               <div class="col-sm-5ths">
                    <a href="/videos/summits/denver-2019/successfully-deploying-massive-applications-on-openstack" target="_blank">
                    <div class="video-wrapper small">
                        <div class="play-button">
                            <img src="{$Top.CloudUrl("images/play-button.png")}">
                        </div>
