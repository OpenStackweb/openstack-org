<% include SangriaPage_SurveyRangeSelector Label='Select version of survey', FormAction=$Top.GetLinkForDeploymentSurveysPerCountry($country), FromPage=ViewDeploymentSurveysPerRegion %>
