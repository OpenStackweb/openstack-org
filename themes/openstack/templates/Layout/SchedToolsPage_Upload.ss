...
<% else %>
	...
	<h2 class="upload-tabs"><a href="{$Link}Upload/{$Presentation.ID}" class="active">Upload a file</a><a href="{$Link}LinkTo/{$Presentation.ID}">Link to an online presentation</a></h2>
