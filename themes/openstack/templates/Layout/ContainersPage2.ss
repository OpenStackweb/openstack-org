    ...
    <div class="container content">
        <div class="row section" id="introduction">
            <div class="col-lg-12">
                ...
                <p>In this paper, we’re going to explore how containers work within OpenStack, examine various use cases, and provide an overview of open source projects, from OpenStack and elsewhere, that help make containers a technology that’s easily adopted and utilized.
        ...
        <div class="row section" id="integration-points">
            <div class="col-lg-12">
                ...
                <p>This opens up an opportunity to not just run OpenStack virtualization on a bare-metal cloud, but to also run bare-metal Kubernetes-only installations that can take full advantage of the identity, storage, networking, and other cloud APIs available through OpenStack services.
                </p>
                ...
                <li><p>A webhook-based authentication and authorization interface to Keystone. Each mode, authentication and authorization, can be configured independently of one another. Though a work in progress, the interface supports a soft-multi-tenancy that backs Kubernetes RBAC with OpenStack Keystone.</p></li>
                </ul>
        ...
        <div class="row section" id="case-studies">
            <div class="col-lg-12">
                ...
                <div class="tab-content">
                    ...
                    <div id="att" class="tab-pane fade in active">
                        <h4 class="subtitle">AT&#38;T</h4>
                        <p>AT&T, one of the largest telecommunications companies in the world, leverages container technology to deploy and manage OpenStack itself, relying on infrastructure containers to generate simplicity and efficiency, with the aim of building their 5G infrastructure on containerized OpenStack. 
                        </p> 
                    ...
                    <div id="cern" class="tab-pane fade">
                        ...
                        <p>CERN has been running OpenStack in production since 2013 and is now providing services for virtual machines, bare-metal and containers within a single cloud. Containers run on either virtual machines or bare-metal depending on the use cases, all provisioned via OpenStack Magnum. A selection of different container technologies are available including Kubernetes, Docker Swarm and DC/OS.
                        </p> 
                    ...
                    <div id="sk" class="tab-pane fade">
                        ...
                        <p>In practical use, SKT has already seen a large number of benefits from deploying OpenStack on Kubernetes including:
                        </p>
                        <ul>
                            <li>
                            ...
                            <li>
                                <p>Rapid adoption of advanced release methodologies, including blue-green deployment, canary releases.
                                </p>
                            </li>
                            <li>
                        ...
                        <p>SKT is still testing the approach, but is actively moving towards running their OpenStack-Helm deployments in production. By end of this year, SKT will have at least three production clusters, with the fourth and largest coming online in 2019. These use cases include:
                        </p>
                        <ul>
                            <li>
                            ...
                            <li>
                                <p>A telco network infrastructure built on virtual network functions (planned to open sometime in 2019)</p>
                            </li>
                        </ul>
                ...
                <div id="accordion" class="panel-group">
                    <div class="panel">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a href="#airship" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion">Airship</a>
                            </h4>
                        </div>
                        <div id="airship" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Airship is a collection of interoperable and loosely coupled open source tools that provide automated cloud provisioning and management in a declarative way, based around Kubernetes as an application platform.
</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel">
                        ...
                        <div id="cinder" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>OpenStack Cinder offers block storage as a service, providing a single API backed by over seventy different possible storage drivers.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="cloud-provider-openstack" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Cloud Provider OpenStack is the implementation of the Kubernetes Cloud Provider interface. It allows an OpenStack-hosted Kubernetes cluster to directly access storage and load balancer resources in the OpenStack cloud.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="calico" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Calico is a network overlay with drivers for both Kubernetes and OpenStack that features L3-only routing.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="cyborg" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Cyborg is an OpenStack project that provides a general management framework for hardware accelerators including FPGA, GPU, ASIC, and others. Work is in progress to surface a general hardware interface to pods.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="docker" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Docker is an open source container virtualization framework, used to host containerized applications.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="helm" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Helm is the official package manager for Kubernetes. Application deployments are described by Helm-Charts, which can be automatically deployed and managed on a Kubernetes cluster.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="ironic" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Ironic is the OpenStack bare-metal service. Running either as a standalone service or as a driver to OpenStack Nova, it can manage the complete life-cycle of bare-metal systems, including enrollment, provisioning, maintenance, and decommissioning.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="loci" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>LOCI is an OpenStack project to build lightweight, OCI compliant containers for OpenStack projects.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="lxc" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>LXC is a low-level container virtualization interface that takes advantage of Linux kernel namespace isolation and other technologies to create isolated linux runtimes.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="kata-containers" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Kata Containers is a standard implementation of lightweight Virtual Machines (VMs) that feel and perform like containers, but provide the workload isolation and security advantages of VMs.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="keystone" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Keystone is the OpenStack Identity service that provides means for authenticating and managing user accounts and role information primarily for the OpenStack cloud environment, but also as a plugin to other environments, including Kubernetes.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="kolla-containers" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Kolla (Containers) is an OpenStack project to build containers for each OpenStack service. It includes a sophisticated build and templating systems, and is capable of building containers from both source and packages on a variety of host operating systems.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="kolla-ansible" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Kolla Ansible is an OpenStack project that uses Ansible to deploy and maintain a full OpenStack installation using Kolla containers.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="kubernetes" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Kubernetes is a container orchestration system that delivers robust and highly-available applications on top of cloud-infrastructure.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="kuryr" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Kuryr is an OpenStack project that provides a Neutron network overlay to container runtimes, including Docker and Kubernetes. It aims to be the “integration bridge” for container and VM networks.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="magnum" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Magnum is an OpenStack project that offers managed container platforms as a service, including Kubernetes, Docker Swarm, Mesos, and DC/OS platforms. It is capable of creating tenant isolated application platforms through a simple user-facing API.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="neutron" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Neutron is the OpenStack software-defined networking service, offering a single API to deliver dynamic network infrastructure backed by dozens of network drivers.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="openstack-ansible" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>OpenStack Ansible is a project for building OpenStack services into LXC containers, and for deploying and managing OpenStack installations within those containerized services.</p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                    ...
                    <div class="panel">
                        ...
                        <div id="qinling" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Qinling is an OpenStack project to deliver Functions as a Service. Qinling supports different container orchestration platforms, such as Kubernetes and Docker Swarm, as well as different function package storage backends such as local file-store, OpenStack Swift, and S3.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="triple-o" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>TripleO is a project aimed at installing, upgrading and operating OpenStack clouds using OpenStack’s cloud services as the foundation - building on Nova, Ironic, Neutron, Heat and Ansible to automate cloud management. </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div id="zun" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>Zun is the OpenStack Containers service. It aims to provide an API service for running application containers without the need to manage servers or clusters. </p>
                            </div>
                        </div>
                    </div>
                </div>
