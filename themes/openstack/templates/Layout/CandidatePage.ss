...
<% if Candidates %>
<% loop Candidates %>
<div class="span-7"><a href="/election/2012-board-election/candidates/#{$FirstName}{$LastName}">$FirstName $LastName</a></div>
<% end_loop %>
...
<a name="{$FirstName}{$LastName}"></a>
<div class="details span-20 last">
<div class="last name-and-title"><h3>$FirstName $LastName</h3>
