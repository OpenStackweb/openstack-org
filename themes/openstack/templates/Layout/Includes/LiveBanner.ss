        ...
        <div class="col-md-9 col-xs-12 col-sm-9 col-lg-10">
            <div class="row">
                ...
                <div class="col-md-10 col-sm-10">
                    ...
                    <p>Submit your open source demos and production use cases across categories ranging from private, hybrid and public cloud to containers, hardware enablement, and 5G</p>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-xs-12 col-sm-3 col-lg-2">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-12 cta-container">
                    <a href="https://openinfra.dev/summit/vancouver-2023">Submit Your Presentation
