            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-4 col-sm-offset-2">
                    <div class="download-container">
                        ...
                        <a class="download-btn" alt="Bare Metal White Paper" type="button" href="/use-cases/bare-metal/how-ironic-delivers-abstraction-and-automation-using-open-source-infrastructure">
    ...
    <div class="overview baremetal">
        ...
        <!-- Testimonial -->
        <section class="baremetal-grayback testimonials">
            <div class="container">
                <div class="row ">
                    <div class="col-sm-12">
                        <div class="intro-message"> 
        ...
        <!-- Use Cases-->
        <section class="baremetal-white use-cases-info">
            <div class="container">
                        ...
                        <div class=""> 
                            ...
                            <div class="row">
                                <div class="col-sm-4 single">
                                    <img class="" src="{$Top.CloudUrl("images/baremetal/icon-lifecycle.png")}">
                                    <p>Automating the entire server infrastructure  lifecycle of deployments to updates  to decommissioning.</p>
                                </div>
                                <div class="col-sm-4 single">
                                    <img class="" src="{$Top.CloudUrl("images/baremetal/icon-network.png")}">
                                    <p>Delivering cloud-like bare-metal infrastructure with multi-tenant networks to end users when used as a driver to OpenStack Nova.</p>
                                </div>
                                <div class="col-sm-4 single">
        ...
        <section class="baremetal baremetal-ecosystem">
            <div class="container">
                ...
                <div class="row five-columns row06">
                    ...
                    <div class="col-md-5th-1 col-sm-4">
                    <img class="ecosystem-logo" src="{$Top.CloudUrl("assets/baremetal/red-hat-sm.png")}" alt="RedHat logo">
                    </div>
                    <div class="col-md-5th-1 col-sm-4">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/Q-LukNfu2L0?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
          </div>
