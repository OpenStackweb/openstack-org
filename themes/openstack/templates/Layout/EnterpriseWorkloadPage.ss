...
<div class="enterprise-bar">
                                   ...
                                   <div class="col-sm-7 link-back">
                                    ...
                                    <div class="col-sm-5">
                                        <ul class="list-inline filters">
                                            <li>
                                                <i class="fa fa-database fa-2x"></i><span>Portability</span>
                                            </li>
                                            <li>
    ...
    <div class="content-section-a steps-section">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h2 class="section-heading">From Camera to Couch</h2>
                    <p class="lead">Maximizing efficiency and service to studios</p>
                    <p>
                ...
                <div class="col-sm-6">
                    ...
                    <p>
                        ...
                        <ol>
                            ...
                            <li>
                                Collaborative process until footage is approved as final.                            
                            </li>
                            <li>
        ...
        <div class="container">
            <div class="row">
                <div class="row platform-title-center">
                    <h1>Workload and Data Portability Across OpenStack Clouds</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-8 col-sm-push-2">
                    ...
                    <ul>
                        <li>OpenStack’s REST APIs</li>
                        <li>A required set of capabilities encompassing must-include code and must-pass API tests for all OpenStack products</li>
                        <li>Easily shared data within one geographically dispersed cloud or among many clouds</li>
                    </ul>
                    <p>
                        OpenStack values interoperability because it enables optimal IT decision making as seen in DigitalFilm Tree's workflow.  All clouds, distributions and other products labelled "OpenStack" adhere to <a href="http://www.openstack.org/interop/">interoperability requirements</a> that enable workload portability across a multitude of public and private clouds, so workflows can function seamlessly with the right capabilities at the optimal cost.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="content-section-a steps-section">
        <div class="container">
            <div class="row">
                <div class="row platform-title-center">
                    <h1>Simple security for Workload Portability Across OpenStack Clouds</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <h2 class="section-heading">Federated Identity</h2>
                    <p>
                        <em>Workload and data portability, though essential, isn’t enough.</em>
                    </p>
                    <p>
            ...
            <h2 class="section-heading center">Benefits of OpenStack - One Platform, Many Clouds</h2>
                <div class="col-sm-3 federated-benefits">
                    ...
                    <div class="events-wrapper">
                        <div class="row">
                            <div class="col-lg-12 col-sm-12">
                                <h2>You Can Also Find Us At Our Upcoming Events</h2>
                            </div>
                        </div>
                        ...
                        <div class="row more-events">
                                ...
                                <div class="col-lg-9">
                                    <ul>
                                        <li><a href="http://www.oscon.com/open-source-2015">OSCON</a>,  July 22, 7-8:30pm, Portland, Oregon</li>
                                        <li><a href="http://www.gartner.com/events/na/catalyst">Gartner Catalyst Conference</a>, August 10-13, 2015 in San Diego, California</li>
                                        <li><a href="http://www.gartner.com/events/na/orlando-symposium">Gartner Symposium/ITxpo</a>, October 4-8, 2015 in Orlando, Florida</li>
                                    </ul>
                                </div>
                            </row>
                    </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p class="download-text">
                ...
                <iframe width="560" height="315" src="//www.youtube.com/embed/5WG4DFXHT18?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
          </div>
          <div class="modal-footer">
          </div>
        </div><!-- /.modal-content -->
