  ...
  <div class="row">
	...
	<div class="span-18 last">
		<% if CurrentMember %>
			...
			<p><strong>Note:</strong> Please submit your presentations, panels and workshops in this form. A separate system to submit Design Summit working sessions will open closer to the Summit.</p>
			$AddTalkForm
