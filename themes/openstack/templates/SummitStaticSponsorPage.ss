...
<head>
    ...
    <title>OpenStack Summit | How To Sponsor | OpenStack Summit</title>
...
<div class="white" id="audience">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-push-2">
                ...
                <p class="audience-intro">
                    </p><p>The Summit has experienced tremendous growth since its inception, and we're proud of the diverse audience reached at each one. Here's a quick look at the audience who attended the Vancouver Summit in May 2015.</p>
                <p></p>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <h5 class="section-title">
                    November 2015 Vancouver OpenStack Summit Metrics:
                </h5>
                <div class="row">
        ...
        <script src="/themes/openstack/static/js/sponsor.js"></script>
        
        <script src="/themes/openstack/static/js/Chart.min.js"></script>
