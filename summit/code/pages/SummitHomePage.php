...
class SummitHomePage extends SummitPage {
    ...
    private static $allowed_children = array ('SummitOverviewPage', 'SummitFutureLanding', 'SummitBostonLanding', 'RedirectorPage', 'SummitHighlightsPage', 'SummitStaticAboutPage', 'SummitStaticSponsorPage', 'SummitNewStaticAboutPage');
