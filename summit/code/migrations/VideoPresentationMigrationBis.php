...
class VideoPresentationMigrationBis extends AbstractDBMigrationTask
{

    protected $title = "VideoPresentation to PresentationVideo Migration fixing bug San Diego";
    ...
    private function ensureLegacySummits()
    {
        if (!Summit::get()->filterAny([
            ...
            $this->incrementStat($sanDiego->ID, 'Summits created');
        }
        if (!Summit::get()->filterAny([
            ...
            $this->incrementStat($portland->ID, 'Summits created');
        }
        ...
        if (!Summit::get()->filter('Title:PartialMatch', 'Atlanta')->first()) {
            ...
            $this->incrementStat($atlanta->ID, 'Summits created');
        }
