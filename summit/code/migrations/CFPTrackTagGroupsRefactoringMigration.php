...
final class CFPTrackTagGroupsRefactoringMigration extends AbstractDBMigrationTask
{
    ...
    {
       $queries = [
           "INSERT INTO DefaultTrackTagGroup
...
TagGroup;",
           "INSERT INTO DefaultTrackTagGroup_AllowedTags
...
WHERE SummitID = 24;",
           "DROP TABLE Summit_CategoryDefaultTags;",
           "DROP TABLE TagGroup;",
...
INNER JOIN TrackTagGroup ON DefaultTrackTagGroup.`Label` = TrackTagGroup.`Label`;",
           "ALTER TABLE PresentationCategory_AllowedTags DROP COLUMN `Group`;",
           "ALTER TABLE PresentationCategory_AllowedTags DROP COLUMN `IsDefault`;"
       ];
