...
class RSVPMultiValueQuestionTemplate
    ...
    implements IRSVPMultiValueQuestionTemplate {
    ...
    (
        'DefaultValue' => 'RSVPQuestionValueTemplate',
    );
    ...
    (
        'Values' => 'RSVPQuestionValueTemplate'
    );
    ...
    public function DDLValues(){
        ...
        if(isset($_REQUEST["RSVPQuestionTemplateID"])) {
            $owner = $_REQUEST["RSVPQuestionTemplateID"];

            if (isset($owner)) {
                $sqlQuery = new SQLQuery();
                $sqlQuery->setSelect("ValueID");
                $sqlQuery->setFrom("RSVPQuestionTemplate_DependsOn");
                $sqlQuery->setWhere("RSVPQuestionTemplateID = {$owner} AND ChildID = {$this->ID}");
