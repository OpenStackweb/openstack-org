...
/**
 * Class PresentationCreatorNotificationEmailMessageSender
 */
final class PresentationCreatorNotificationEmailMessageSender implements IMessageSenderService
{
    /**
     * @param mixed $subject
    ...
    public function send($subject)
    {
        ...
        $email_template = PermamailTemplate::get_by_identifier('presentation-creator-notification');
        ...
        $email->setUserTemplate('presentation-creator-notification');
