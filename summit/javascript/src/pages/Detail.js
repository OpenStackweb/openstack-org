          ...
          <div className="voting-content-body">
        	...
        	{!pres.can_vote &&
        		<div style={{clear:'both'}} className="vote-login">
        			...
        			<a className="btn btn-default" href={ "/Security/login?BackURL=/vote-for-speakers/show/" + pres.id }>I already have an account</a>  <a href="/summit/tokyo-2015/call-for-speakers/?backURL=/call-for-speakers/" className="btn btn-default">Sign up now</a>
        		</div>
        	}
