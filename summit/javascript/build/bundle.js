...
/***/ function(module, exports, __webpack_require__) {
	...
	var VotingApp = __webpack_require__(1);
	var Main = __webpack_require__(2);
	var Detail = __webpack_require__(3);
	var DefaultDetail = __webpack_require__(4);
	var Router = __webpack_require__(7);
	var Route = Router.Route;
	var Routes = Router.Routes;
	var DefaultRoute = Router.DefaultRoute;
	var Cortex = __webpack_require__(5);

	var routes = React.createElement(
		Route,
		{ path: "/summit/vancouver-2015/speakers", handler: VotingApp },
		React.createElement(
			Route,
			{ name: "home", path: "module", handler: Main },
			React.createElement(DefaultRoute, { handler: DefaultDetail }),
			React.createElement(Route, { name: "detail", path: "show/:presentationID", handler: Detail })
		)
	);

	var RootComponent;
	Router.run(routes, Router.HistoryLocation, function (Handler) {
		RootComponent = React.render(React.createElement(Handler, { store: Cortex }), document.getElementById("wrap"));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6);
	var Router = __webpack_require__(7);
	var Backend = __webpack_require__(227);
	...
	module.exports = React.createClass({ displayName: "VotingApp",
	  ...
	  _registerErrorHandlers: function _registerErrorHandlers() {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "a",
	        { href: "#", className: "voting-open-panel" },
	        React.createElement("i", { className: "fa fa-bars fa-2x collapse-voting-nav" })
	      ),
	      React.createElement(
	        "div",
	        { className: "container" },
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                "div",
	                { className: "voting-app-logo" },
	                React.createElement("img", { ref: "logo", className: "summit-hero-logo", src: "summit/images/voting-logo.svg", onError: this._handleLogoError, alt: "OpenStack Summit" })
	              )
	            ),
	            React.createElement(
	              "div",
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                "div",
	                { className: "voting-app-details" },
	                React.createElement(
	                  "a",
	                  { href: "/summit/", className: "btn" },
	                  "Summit Details"
	                )
	              )
	            )
	        ...
	        React.createElement(
	          "div",
	          { className: "row", id: "app" },
	          React.createElement(Router.RouteHandler, { store: this.props.store })
	        )
	      )
	    );
	  },

	  _handleLogoError: function _handleLogoError() {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var React = __webpack_require__(6);
	var DropdownSelector = __webpack_require__(10);
	var DropdownItem = __webpack_require__(11);
	var Router = __webpack_require__(7);
	var Backend = __webpack_require__(227);
	var assign = __webpack_require__(13);
	var PresentationList = __webpack_require__(12);
	var SearchBar = __webpack_require__(228);
	...
	module.exports = React.createClass({ displayName: "Main",
	  ...
	  _keyListener: function _keyListener(e) {
	    if (e.keyCode === 37) {
	      return this._navigateAdjacentPresentation(-1);
	    }if (e.keyCode === 39) {
	      return this._navigateAdjacentPresentation(1);
	    }
	  },

	  _updateQueryString: function _updateQueryString(params) {
	    var query = assign({}, this.getQuery(), params);

	    for (var i in query) {
	      if (query[i] === null) delete query[i];
	    }

	    return this.transitionTo(this.getPathname(), {}, query);
	  },

	  _handleSearch: function _handleSearch(text) {
	  ...
	  _handleCategoryChange: function _handleCategoryChange(key) {
	  ...
	  _handlePresentationSelected: function _handlePresentationSelected(pres) {
	    this.transitionTo("detail", { presentationID: pres.id }, this.getQuery());
	  },

	  _paramsHaveChanged: function _paramsHaveChanged() {
	    return !this._latestParams || JSON.stringify(this._latestParams) !== JSON.stringify(this.getQuery());
	  },

	  _processParams: function _processParams() {
	    this.setState({
	  ...
	  _loadPresentations: function _loadPresentations() {
	  ...
	  _navigateAdjacentPresentation: function _navigateAdjacentPresentation(adder) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "div",
	        { className: "col-lg-3 col-md-3 col-sm-3 voting-sidebar" },
	        React.createElement(
	          "div",
	          { className: "voting-app-details-link" },
	          React.createElement(
	            "a",
	            { href: "#" },
	        ...
	        React.createElement(SearchBar, { className: "text voting-search-input", placeholder: "Search", id: "filter-field", onUpdate: this._handleSearch, initialText: keyword }),
	        React.createElement(
	          DropdownSelector,
	          { onChange: this._handleCategoryChange, defaultSelection: activeCategoryData.id },
	          React.createElement(
	            DropdownItem,
	            { val: null },
	            "All Categories"
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            null,
	            "(",
	            store.presentations.count(),
	            " showing)"
	          )
	        ),
	        React.createElement(PresentationList, {
	      ...
	      React.createElement(
	        "div",
	        { className: "col-lg-9 col-md-9 col-sm-9 voting-content-body-wrapper" },
	        React.createElement(Router.RouteHandler, { store: this.props.store })
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backend = __webpack_require__(227);
	var Router = __webpack_require__(7);
	var HotkeyBar = __webpack_require__(225);
	var HotkeyButton = __webpack_require__(226);
	var share = __webpack_require__(229);
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement("div", { className: "sharing-section", dangerouslySetInnerHTML: { __html: share } })
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DefaultDetail = React.createClass({
		displayName: "DefaultDetail",

		render: function render() {
			return React.createElement(
				"h2",
				null,
				"Choose a presentation from the left."
			);
		}

	});

	module.exports = DefaultDetail;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cortex = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function get(url, data) {
	    return request.get(url).query(data || {}).timeout(TIMEOUT);
	}

	function post(url, data) {
	    return request.post(url).type("form").send(data || {}).timeout(TIMEOUT);
	}

	function put(url, data) {
	    return request.put(url).type("form").send(data || {}).timeout(TIMEOUT);
	}
	...
	var Api = {
	    ...
	    registerErrorHandler: function registerErrorHandler(error, handler) {
	        _errorHandlers["error_" + error] = handler;
	    },

	    getSummitData: function getSummitData(id, callback) {
	        var url = makeUrl("/summit/" + id);
	        var key = "SUMMIT_DATA";
	        abortPendingRequests(key);

	        return _pendingRequests[key] = finalise(get(url), callback);
	    },

	    getPresentations: function getPresentations(data, callback) {
	        var url = API_URL;
	        var key = "PRESENTATIONS";
	        abortPendingRequests(key);

	        return _pendingRequests[key] = finalise(get(url, data), callback);
	    },

	    getPresentation: function getPresentation(id, callback) {
	    ...
	    setPresentationVote: function setPresentationVote(presID, v) {
	        var url = makeUrl("/presentation/" + presID + "/vote");
	        var key = "VOTE";
	        abortPendingRequests(key);

	        return _pendingRequests[key] = finalise(post(url, { vote: v }));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DropdownSelector = React.createClass({ displayName: "DropdownSelector",
		...
		_bodyClickHandler: function _bodyClickHandler(e) {
		...
		_handleSelection: function _handleSelection(key, e) {
			e.preventDefault();
			this.setState({
				selection: key
			});
		...
		render: function render() {
			...
			return React.createElement(
				"div",
				{ className: "btn-group voting-dropdown " + (this.state.open ? "open" : ""), onClick: this._toggleOpen },
				React.createElement(
					"button",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PresentationList = React.createClass({ displayName: "PresentationList",
	  ...
	  _resizeListener: function _resizeListener(e) {
	  ...
	  render: function render() {
	    return React.createElement(
	      "ul",
	      { className: "presentation-list", style: { height: this.state.height } },
	      this.props.presentations.map((function (pres) {
	        var klass = this.props.selected == pres.id ? "active" : pres.user_vote ? "completed" : "upcoming";
	        return React.createElement(
	          "li",
	          { key: pres.id, className: klass, onClick: this.props.onSelect.bind(null, pres) },
	          React.createElement(
	            "a",
	            null,
	            pres.title
	      ...
	      this.props.hasMore && React.createElement(
	        "li",
	        { className: "load-more" },
	        React.createElement(
	          "a",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (function () {
	  var cortexPubSub = __webpack_require__(62),
	      DataWrapper = __webpack_require__(63)(cortexPubSub),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavigationContext = __webpack_require__(71);
	var ScrollHistory = __webpack_require__(72);
	var StateContext = __webpack_require__(73);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LinkedStateMixin = __webpack_require__(82);
	var React = __webpack_require__(15);
	var ReactComponentWithPureRenderMixin = __webpack_require__(83);
	var ReactCSSTransitionGroup = __webpack_require__(84);
	...
	var update = __webpack_require__(88);
	...
	if ("production" !== process.env.NODE_ENV) {
	  ...
	  React.addons.TestUtils = __webpack_require__(90);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (cortexPubSub) {
	  var deepDiff = __webpack_require__(148).diff;
	  ...
	  var ArrayWrapper = __webpack_require__(145),
	      HashWrapper = __webpack_require__(146);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(68);
	var merge = __webpack_require__(150).merge;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(68);
	var canUseDOM = __webpack_require__(38).canUseDOM;
	var getWindowScrollPosition = __webpack_require__(147);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTransitionGroup = React.createFactory(__webpack_require__(85));
	var ReactCSSTransitionGroupChild = React.createFactory(__webpack_require__(153));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTestUtils = {
	  ...
	  isTextComponent: function isTextComponent(inst) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function (undefined) {
	  ...
	  Object.defineProperties(accumulateDiff, {
	    ...
	    isConflict: { value: function value() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createArrayFrom = __webpack_require__(223);
	var getMarkupWrap = __webpack_require__(222);
	var invariant = __webpack_require__(68);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HotkeyBar = React.createClass({
		displayName: "HotkeyBar",

		_handleSelection: function _handleSelection(val) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HotkeyButton = React.createClass({
		...
		render: function render() {
			return React.createElement(
				"li",
				{ className: "voting-rate-single " + (this.props.selected ? "active" : ""), onClick: this.props.onChange },
				React.createElement(
					"a",
					null,
					this.props.children,
					React.createElement(
						"div",
						{ className: "voting-shortcut" },
						this.props.hotkeyDescription
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backend = {
		...
		findByID: function findByID(dataWrapper, id) {
			if (!dataWrapper.getValue()) {
				return false;
		...
		getPresentationByID: function getPresentationByID(id) {
			return Backend.findByID(Cortex.presentations, id);
		},

		getPresentations: function getPresentations(params) {
		...
		resetPresentations: function resetPresentations() {
			Cortex.presentations.remove();
			Cortex.presentations.set([]);
		},

		getSummitData: function getSummitData(id) {
			API.getSummitData(id, function (response) {
				Cortex.summit.set(response.body);
			});
		},

		setPresentationVote: function setPresentationVote(presID, vote) {
			console.log("vote");
		...
		setPresentationActive: function setPresentationActive(presID) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBar = React.createClass({
		...
		render: function render() {
			return React.createElement("input", _extends({}, this.props, { value: this.state.searchText, type: "text", ref: "search", onChange: this._handleChange }));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "<div class=\"single-voting-share\">" + "<iframe id=\"twitter-widget-0\" scrolling=\"no\" frameborder=\"0\" allowtransparency=\"true\" src=\"http://platform.twitter.com/widgets/tweet_button.26f01cfa05bff9af89657dcbd8f7b705.en.html#_=1425254465668&amp;count=none&amp;dnt=false&amp;id=twitter-widget-0&amp;lang=en&amp;original_referer=http%3A%2F%2Fstatic.openstack.dev%2Fspeaker%2Fvoting%2Flogged-in%2F&amp;size=m&amp;text=Vote%20For%20Vancouver%20Summit%20Presentations%20%7C%20OpenStack%20Open%20Source%20Cloud%20Computing%20Software&amp;url=http%3A%2F%2Fstatic.openstack.dev%2Fspeaker%2Fvoting%2Flogged-in%2F\" class=\"twitter-share-button twitter-tweet-button twitter-share-button twitter-count-none\" title=\"Twitter Tweet Button\" data-twttr-rendered=\"true\" style=\"width: 57px; height: 20px;\"></iframe>" + "<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>" + "</div>" + "<div class=\"single-voting-share\">" + "<div id=\"___plus_0\" style=\"text-indent: 0px; margin: 0px; padding: 0px; border-style: none; float: none; line-height: normal; font-size: 1px; vertical-align: baseline; display: inline-block; width: 58px; height: 20px; background: transparent;\"><iframe frameborder=\"0\" hspace=\"0\" marginheight=\"0\" marginwidth=\"0\" scrolling=\"no\" style=\"position: static; top: 0px; width: 58px; margin: 0px; border-style: none; left: 0px; visibility: visible; height: 20px;\" tabindex=\"0\" vspace=\"0\" width=\"100%\" id=\"I0_1425254465586\" name=\"I0_1425254465586\" src=\"https://apis.google.com/u/0/se/0/_/+1/sharebutton?plusShare=true&amp;usegapi=1&amp;action=share&amp;annotation=none&amp;origin=http%3A%2F%2Fstatic.openstack.dev&amp;url=http%3A%2F%2Fstatic.openstack.dev%2Fspeaker%2Fvoting%2Flogged-in%2F&amp;gsrc=3p&amp;ic=1&amp;jsh=m%3B%2F_%2Fscs%2Fapps-static%2F_%2Fjs%2Fk%3Doz.gapi.en_GB.6Ex8sbqqgWI.O%2Fm%3D__features__%2Fam%3DAQ%2Frt%3Dj%2Fd%3D1%2Ft%3Dzcms%2Frs%3DAGLTcCNptsKqqHW7DF58vgC3jtM2Wf-Srw#_methods=onPlusOne%2C_ready%2C_close%2C_open%2C_resizeMe%2C_renderstart%2Concircled%2Cdrefresh%2Cerefresh%2Conload&amp;id=I0_1425254465586&amp;parent=http%3A%2F%2Fstatic.openstack.dev&amp;pfname=&amp;rpctoken=93339510\" data-gapiattached=\"true\" title=\"+Share\"></iframe></div>" + "</div>" + "<div class=\"single-voting-share fb-share\">" + "<div class=\"fb-share-button fb_iframe_widget\" data-href=\"https://developers.facebook.com/docs/plugins/\" data-layout=\"button\" fb-xfbml-state=\"rendered\" fb-iframe-plugin-query=\"app_id=600413776716536&amp;container_width=0&amp;href=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;layout=button&amp;locale=en_US&amp;sdk=joey\"><span style=\"vertical-align: bottom; width: 56px; height: 20px;\"><iframe name=\"f112f561d8\" width=\"1000px\" height=\"1000px\" frameborder=\"0\" allowtransparency=\"true\" scrolling=\"no\" title=\"fb:share_button Facebook Social Plugin\" src=\"http://www.facebook.com/v2.0/plugins/share_button.php?app_id=600413776716536&amp;channel=http%3A%2F%2Fstatic.ak.facebook.com%2Fconnect%2Fxd_arbiter%2FrFG58m7xAig.js%3Fversion%3D41%23cb%3Df7c476df4%26domain%3Dstatic.openstack.dev%26origin%3Dhttp%253A%252F%252Fstatic.openstack.dev%252Ff23884fc5%26relation%3Dparent.parent&amp;container_width=0&amp;href=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;layout=button&amp;locale=en_US&amp;sdk=joey\" style=\"border: none; visibility: visible; width: 56px; height: 20px;\" class=\"\"></iframe></span></div>" + "</div>";
