...
<schedule-grid>
    ...
    <div class="row">
            <div class="container" id="events-container">
               ...
               <schedule-grid-events summit="{ summit }" default_event_type_color={ default_event_type_color } search_url={ search_url } schedule_filters={ schedule_filters } base_url={ base_url } schedule_api={ schedule_api }></schedule-grid-events>
            </div>
    </div>
