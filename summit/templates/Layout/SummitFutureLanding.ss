...
<div class="tokyo-landing-wrapper shanghai" style="background-image: url('{$SummitImage.Image.getURL()}')">
    <div class="container">
        <div class="landingintro">
    	    <div class="row">
                <div class="col-md-12">
                    <img class="tokyo-landing-logo" src="{$Top.CloudUrl('assets/Summit-Logo-Web-w.svg')}"
                             onerror="this.onerror=null; this.src={$Top.CloudUrl('assets/Summit-Logo-Web-w.svg')}" alt="OpenStack Infrastructure Summit">
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 join-us-text-white">
                    BERLIN, GERMANY
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 join-us-text-white-date">
                        OCTOBER 19-23, 2020
                </div>
            </div>
            <!-- <div class="row">
...
<div class="row future-text-wrapper white">
    <div class="row">
        ...
        <p>Centrally located at the <a href="https://www.google.com/maps/place/bcc+Berlin+Congress+Center+GmbH/@52.5206407,13.4138012,17z/data=!3m1!4b1!4m5!3m4!1s0x47a84e1898c0bf43:0xd2a15220241f2080!8m2!3d52.5206375!4d13.4159899" style="color:#fff;text-decoration:underline;" target="_blank">bcc Berlin Congress Center GmbH</a></p>
        <p><br/><br/></p>
        <p><img class="tokyo-landing-logo" src="https://object-storage-ca-ymq-1.vexxhost.net/swift/v1/6e4619c416ff4bd19e1c087f27a43eea/www-assets-prod/summits/Vancouver2020/project-logos.png" onerror="this.onerror=null; this.src=https://object-storage-ca-ymq-1.vexxhost.net/swift/v1/6e4619c416ff4bd19e1c087f27a43eea/www-assets-prod/summits/Vancouver2020/project-logos.png" alt="OpenStack Infrastructure Summit"></p>
        </div>
    </div>
</div>
