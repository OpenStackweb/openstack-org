    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-lg-8 col-md-6">
                <h3 class="title-section">Denver 2019 Open Infrastructure Summit Featured Speakers</h3>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 text">
                ...
                <p>We are a diverse community of professionals, and the OpenStack Foundation is dedicated to providing an
                    inclusive and safe Summit experience for everyone. View the <a href="https://www.openstack.org/summit/denver-2019/code-of-conduct/" target="_blank">Summit Code of Conduct</a> for more information.</p>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12">
                ...
                <div class="pink box item big">
                    ...
                    <a class="btn" href="/summit/denver-2019/sample-letter/">Sample Letter <i class="fa fa-arrow-right"></i></a>
                </div>
