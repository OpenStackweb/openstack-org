			...
			<div class="col-lg-9 col-md-9">
				<div class="presentation-main-panel">				
					<div class="main-panel-section">
						<h2><% if $Presentation.Speakers %>Presentation Speakers<% else %>Add your first speaker<% end_if %></h2>
					</div>
	
					<div class="row">
						<div class="col-lg-12">
						<div class="presentation-steps">
							<a href='$Presentation.EditLink' class="step"><i class="fa fa-file-text-o"></i> Presentation Details</a>
