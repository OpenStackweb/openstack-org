            ...
            <div class="col-sm-6">
                <div class="session-wrapper" id="containers">
                    ...
                    <div class="session-list-tracks">
                        ...
                        <ul>
                            <li class="tracks-tooltip" title="If you are a cloud architect or involved in planning your cloud srategy, this track will discuss popular reference architectures, configuration options, workload optimiziation, and architecture show and tell, where experienced users will share their architectures and experiences.">Architectural Decisions</li>
                ...
                <div class="session-wrapper" id="arch">
                    ...
                    <div class="session-list-tracks">
                        ...
                        <ul>
                            ...
                            <li class="tracks-tooltip" title="Sharing knowledge is a core value for the OpenStack community. In the case sudies track, you'll hear directly from enterprises, service providers and application developers who are using OpenStack to address their business problems. Learn challenges, best practices and measured results. ">Case Studies</li>
