                ...
                <div class="carousel-inner">
                    <div class="item active" id="sponsorsCarousel-0">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
                                <img alt="AT&T" src="{$Top.CloudUrl('assets/companies/main_logo/att-lg2.jpg')}" class="big-logo-company company-logo"/>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
                                <img alt="Ericsson" src="{$Top.CloudUrl('assets/companies/main_logo/ericsson-lg.jpg')}" class="big-logo-company company-logo"/>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
                                <img alt="Huawei" src="{$Top.CloudUrl('assets/companies/main_logo/huawei-new-lg.jpg')}" class="big-logo-company company-logo"/>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
                                <img alt="Intel" src="{$Top.CloudUrl('assets/companies/main_logo/intel-xlg.jpg')}" class="big-logo-company company-logo"/>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
                                <img alt="Rackspace" src="{$Top.CloudUrl('assets/companies/main_logo/Rackspace-Red-lg.jpg')}" class="big-logo-company company-logo"/>
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-2 centered-column space"></div>
                    </div>
                    <div class="item" id="sponsorsCarousel-1">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
                                <img alt="Tencent" src="{$Top.CloudUrl('assets/companies/main_logo/Tencent-vert-lg.jpg')}" class="big-logo-company company-logo"/>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
                                <img alt="99 Cloudbase" src="{$Top.CloudUrl('assets/companies/main_logo/99cloud-new-lg.jpg')}" class="big-logo-company company-logo"/>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
                                <img alt="Canonical" src="{$Top.CloudUrl('assets/companies/main_logo/ubuntu-lg.jpg')}" class="big-logo-company company-logo"/>
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-2 centered-column space"></div>
                    </div>
                    <div class="item" id="sponsorsCarousel-2">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
                            <img alt="City Network" src="{$Top.CloudUrl('assets/companies/main_logo/CityNetwork-Logo-Regular-500px-RGB.png')}" class="big-logo-company company-logo"/>
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-2 centered-column space"></div>
                    </div>
                    <div class="item" id="sponsorsCarousel-3">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
                            <img alt="Easystack" src="{$Top.CloudUrl('assets/companies/main_logo/easystack-lg2.jpg')}" class="big-logo-company company-logo"/>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
                            <img alt="Fiberhomee" src="{$Top.CloudUrl('assets/companies/main_logo/fiberhome-lg.jpg')}" class="big-logo-company company-logo"/>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
                            <img alt="Inspur" src="{$Top.CloudUrl('assets/companies/main_logo/inspur-lg.jpg')}" class="big-logo-company company-logo"/>
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-2 centered-column space"></div>
                    </div>
                    <div class="item" id="sponsorsCarousel-4">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
                            <img alt="H3C" src="{$Top.CloudUrl('assets/companies/main_logo/H3C-lg.jpg')}" class="big-logo-company company-logo"/>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-4 centered-column">
