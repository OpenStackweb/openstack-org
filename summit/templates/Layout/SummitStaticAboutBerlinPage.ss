...
<div class="white about-summit with-arrow" id="who-should-attend">
    <div class="container">
        <div class="row">
            ...
            <!-- <a class="who-section-cta" href="/summit/berlin-2018/summit-categories">Learn more about the content planned for the OpenStack Summit Sydney</a> -->
                </div>
            <div class="col-lg-3 col-md-4 col-sm-4" style="margin-top:30px;">
              <!-- <ul class="help-me-menu">
                <li><a href="/summit/berlin-2018/code-of-conduct"><i class="fa fa-eye"></i>Code of Conduct</a></li>
                <li><a href="/summit/berlin-2018/travel/#visa"><i class="fa fa-plane"></i>Visa Information</a></li>
                <li><a href="/summit/berlin-2018/travel/#travel-support" target="_blank"><i class="fa fa-users"></i>Apply for Travel Support</a></li>
              </ul> -->
            </div>
        </div>
    </div>
...
<div class="light summit-users-wrapper" id="featured-speakers">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <h2>Featured Speakers from our 2017 Summit in Sydney</h2>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="gallery-content">
          <a href="https://openstacksummit2018berlin.eventbrite.com/" target="_blank" class="btn register-btn-lrg" target="_blank">Register Now</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="register-promo-wrapper">
    <div class="container">
        <div class="row">
          ...
          <p>
            <a href="https://openstacksummit2018berlin.eventbrite.com/" target="_blank" class="btn" target="_blank">Register Now</a>
          </p>
            </div>
        </div>
    </div>
