...
<div class="academy-wrapper" id="openstackacademy">
  <div class="container">
    ...
    <div class="row" id="openstackcoa">
        <div class="col-sm-12">
          <hr style="margin-top:60px;">
          <h1 style="margin-bottom: 20px;">Take the COA in Boston</h1>
          <i class="fa fa-trophy" style="color: #3E9B85;font-size: 5.5em;margin-bottom: 20px;"></i>
          <div class="row">
            <div class="col-sm-8 col-sm-push-2">
              <p>
    ...
    <div class="row">
      <div class="col-sm-12">
        <a href="/summit/boston-2017/coa-in-boston" class="btn academy-cta" target="_blank">Learn more about the COA in Boston</a>
      </div>
    </div>
  </div>
</div>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="growth-map-wrapper">
					<img class="growth-map tokyo" src="{$Top.CloudUrl("images/static/boston/map-about-summit.svg")}" alt="OpenStack Summit Growth Chart"> 
