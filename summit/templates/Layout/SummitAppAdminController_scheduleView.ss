    ...
    <div id="page-content-wrapper">
        ...
        <div class="row" style="margin:0">
            <div class="col-md-6 published-container">
                ...
                <schedule-admin-view-published start_time="07:00" end_time="22:00" interval="10" step="5" summit="{ summit }" minute_pixels="4" slot_width="100%"></schedule-admin-view-published>
            ...
            <div class="col-md-6 unpublished-container">
                ...
                <schedule-admin-view-unpublished summit="{ summit }" slot_width="500" interval="10" minute_pixels="4" slot_width="100%"></schedule-admin-view-unpublished>
            </div>
        </div>
    </div>
