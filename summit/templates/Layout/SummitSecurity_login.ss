...
<div class="presentation-app-header">
    ...
    <div class="presentation-app-body">
        ...
        <div class="container">
            ...
            <p>The Summit is organized around Tracks, which are focused on specific open infrastructure problem domains, including Edge Computing, CI/CD, and Private & Hybrid Cloud. Presentations for each Track are determined by a Program Committee for each Track. The Foundation selects the Program Committee members from a list of people nominated by the community. The Foundation strives to recruit Programming Committee members from a diverse set of companies, open source communities, regions and roles across communities (i.e., contributing developers, users and business leaders). To nominate someone for the Summit Programming Committee for a specific Track, please fill out the <a href="https://openstackfoundation.formstack.com/forms/openstackdenver2019_programmingcommitteenom">nomination form</a>.</p>
