<div class="presentation-app-header">
    ...
    <div class="presentation-app-body">
        ...
        <div class="container">
            ...
            <p>The deadline to request to be a Track Chair or nominate someone else for the Barcelona Summit is June 17th. <a href="https://openstackfoundation.formstack.com/forms/openstack_summit_barcelona_track_chair_nominations" target="_blank">Nominations can be made here</a>.</p>
