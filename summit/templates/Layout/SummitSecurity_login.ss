    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <p>On average, the Open Infrastructure Foundation receives more than 1,000 submissions for the Summit. Of those, we are only able to select 25-30% for participation. To decide which talks are accepted, we rely on a Programming Committee as well as a community voting process that will open in January 2019.</p>
