...
<div class="what-to-expect" id="expect">
    <div class="container">
        ...
        <div class="row">
            <div class="video-container col-lg-pull-6 col-md-6 col-sm-12">
            ...
            <div class="text-container col-lg-push-6 col-md-6 col-sm-12">
...
<div class="academy-wrapper" id="Sponsors">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h3>These communities are coming together at the summit</h3>
            </div>
