        ...
        <div class="row">
            <div class="col-sm-12 col-lg-8 col-md-6">
                ...
                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-4 featured">
                    <div class="summit-user-section">
                        <div class="summit-user-image-box">
                            <img src="{$Top.CloudUrl('assets/profile-images/photo200.jpg')}" alt="Mykola Mogylenko" class="summit-user-image">
                        </div>
                        <div class="info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-4 featured">
                    <div class="summit-user-section">
                        <div class="summit-user-image-box">
                            <img src="{$Top.CloudUrl('assets/profile-images/_resampled/SetRatioSize400400-20170707172318.jpg')}" alt="Jinghua Gao"
                ...
                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-4 featured">
                    <div class="summit-user-section">
                        <div class="summit-user-image-box">
                            <img src="{$Top.CloudUrl('assets/profile-images/LucaCervigni.jpeg')}" alt="Luca Cervigni" class="summit-user-image">
                        </div>
                        <div class="info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-4 featured">
                    <div class="summit-user-section">
                        <div class="summit-user-image-box">
                            <img src="{$Top.CloudUrl('assets/profile-images/_resampled/SetRatioSize400400-kubecon2017.jpg')}" alt="Xu Wang" class="summit-user-image">
                        </div>
                        <div class="info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-4 featured">
                    <div class="summit-user-section">
                        <div class="summit-user-image-box">
                            <img src="{$Top.CloudUrl('assets/Uploads/_resampled/SetRatioSize400400-CroppedImage872872-alebre.jpg')}" alt="Adrien Lebre"
                                 class="summit-user-image">
                        </div>
                        <div class="info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-4 featured">
                    <div class="summit-user-section">
                        <div class="summit-user-image-box">
                            <img src="{$Top.CloudUrl('assets/profile-images/DianeMuellerTwitterProfilePic2014.jpeg')}" alt="Diane Mueller" class="summit-user-image">
                        </div>
                        <div class="info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-4 featured">
                    <div class="summit-user-section">
                        <div class="summit-user-image-box">
                            <img src="{$Top.CloudUrl('assets/profile-images/_resampled/SetRatioSize400400-lunkwitz.jpeg')}" alt="Thomas Lunkwitz"
                                 class="summit-user-image">
                        </div>
                        <div class="info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-4 featured">
                    <div class="summit-user-section">
                        <div class="summit-user-image-box">
                            <img src="{$Top.CloudUrl('assets/Uploads/flwang.jpeg')}" alt="Feilong Wang " class="summit-user-image">
                        </div>
                        <div class="info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-4 featured">
                    <div class="summit-user-section">
                        <div class="summit-user-image-box">
                            <img src="{$Top.CloudUrl('assets/Uploads/Stefan-Kroll.jpg')}" alt="Stefan Kroll" class="summit-user-image">
                        </div>
                        <div class="info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-4 featured">
                    <div class="summit-user-section">
                        <div class="summit-user-image-box">
                            <img src="{$Top.CloudUrl('assets/profile-images/RuijingGuo.jpeg')}" alt="Ruijing Guo" class="summit-user-image">
                        </div>
                        <div class="info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-4 featured">
                    <div class="summit-user-section">
                        <div class="summit-user-image-box">
                            <img src="{$Top.CloudUrl('assets/profile-images/_resampled/CroppedImage150150-Lauren-Nelson.png')}"
                ...
                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-4 featured">
                    <div class="summit-user-section">
                        <div class="summit-user-image-box">
                            <img src="{$Top.CloudUrl('assets/Uploads/_resampled/CroppedImage250250-alan.jpg')}" alt="Alan Meadows" class="summit-user-image">
                        </div>
                        <div class="info">
            ...
            <div id="sponsorsCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 centered-column">
                            <a rel="nofollow" href="https://www.canonical.com/">
                                <img alt="Canonical_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/ubuntu-lg.jpg')}"
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 centered-column">
                            <a rel="nofollow" href="http://www.huawei.com/en/">
                                <img alt="Huawei_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/huawei-new-lg.jpg')}"
                                                                                    class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-3 col-md-4 col-sm-6 centered-column">
                            <a rel="nofollow" href="http://www.intel.com/"><img alt="Intel_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/intel-xlg.jpg')}"
                                                                                class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-3 col-md-4 col-sm-6 centered-column">
                            <a rel="nofollow" href="https://www.redhat.com/openstack/?sc_cid=70160000000bEKkAAM&amp;offer_id=701600000006R7KAAU"><img
                                    alt="Red Hat, Inc._big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/redhat-sp-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>
                    ...
                    <div class="item">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.vmware.com/"><img alt="VMware_big_logo"
                                                                                  src="{$Top.CloudUrl('assets/companies/main_logo/vmware-sp-lg.jpg')}"
                                                                                  class="big-logo-company company-logo"></a>
                        </div>
                    ...
                    <div class="item">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.emc.com"><img alt="Dell EMC_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/EMC-lg.jpg" class="big-logo-company company-logo')}"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.symkloud.com"><img alt="Kontron_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/kontron-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.mirantis.com/"><img alt="Mirantis_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/mirantis-lg-van.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.nokia.com/en_int"><img alt="Nokia_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/nokia-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.rackspace.com/cloud/openstack"><img alt="Rackspace_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/rackspace-lg-2016.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://intl.cloud.tencent.com/"><img alt="Tencent Cloud_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/Tencent-vert-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://wwwen.zte.com.cn/en/"><img alt="ZTE Corporation_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/zte-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>
                    </div>
                    <div class="item">
                        <h3>Exhibitor Sponsors</h3>
                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.ambedded.com/"><img alt="Ambedded_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/ambedded-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.arm.com/"><img alt="ARM_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/arm-lg2.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.avinetworks.com/"><img alt="Avi Networks_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/avi-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.b1-systems.de/"><img alt="B1 Systems_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/BSystems.jpg')}" class="big-logo-company company-logo"></a>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.componentsoft.eu"><img alt="Component Soft_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/componentsoft-lg-09-04.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.cumulusnetworks.com"><img alt="Cumulus Networks_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/cumulus-networks-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.datadoghq.com"><img alt="Datadog Inc_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/datadog-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.easystack.io"><img alt="EasyStack_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/easystack-lg2.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.entercloudsuite.com/"><img alt="Enter Cloud Suite_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/cloudsuite-lg-2.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://fairbanks.nl/"><img alt="Fairbanks_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/_resampled/SetWidth300-FAIR-Fairbanks-logo-2016-Website-RGB-3.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://hyper.sh/"><img alt="HyperHQ Inc._big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/hyper-lg-2.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.innovo-cloud.de/"><img alt="iNNOVO Cloud_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/iNNOVO-logo-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.juniper.net"><img alt="Juniper Networks_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/juniper-sp-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.kaloom.com/"><img alt="Kaloom_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/kaloom-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.lenovo.com/"><img alt="Lenovo_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/lenovo-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.mellanox.com/"><img alt="Mellanox_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/mellanox-lg623.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.netapp.com/us/"><img alt="NetApp_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/netapp-sp-lg4.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.nttdata.co.jp/en/"><img alt="NTT Data_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/NTT-Data-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.objectif-libre.com/"><img alt="Objectif Libre_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/objectiflibre.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.oerlikon.com/en/"><img alt="Oerlikon_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/oerlikon-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.ovh.com"><img alt="OVH_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/ovh-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.purestorage.com/"><img alt="Pure Storage_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/purestorage-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.quobyte.com/"><img alt="Quobyte Inc._big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/quobyte-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.scaleuptech.com"><img alt="ScaleUp Technologies_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/_resampled/SetWidth300-SU-openstack-500px.png')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.sevone.com"><img alt="SevOne_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/sevone.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://softiron.com/"><img alt="SoftIron_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/SoftIron-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://storagemadeeasy.com"><img alt="Storage Made Easy_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/sme-large.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://storpool.com"><img alt="StorPool Storage_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/storpool.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://supermicro.com"><img alt="Supermicro_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/supermicro-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.syseleven.de/"><img alt="SysEleven_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/syseleven-lg3.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.triliodata.com"><img alt="TrilioData_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/trilionew-lg2.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://vexxhost.com"><img alt="VEXXHOST, Inc._big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/vexxhost-new-lg.png')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.windriver.com"><img alt="Wind River_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/windriverlg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="https://www.zenko.io/"><img alt="Zenko_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/zenko-lg2.jpg')}" class="big-logo-company company-logo"></a>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="www.superuser.openstack.org"><img alt="Superuser Long Logo_big_logo"
                                                                                      src="{$Top.CloudUrl('assets/companies/main_logo/superuser-lg.jpg')}" class="big-logo-company company-logo"></a>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-2 centered-column">
                            <a rel="nofollow" href="http://www.decisive-media.com"><img alt="TelecomTV_big_logo" src="{$Top.CloudUrl('assets/companies/main_logo/ttv-lg.jpg')}"
                                                                                        class="big-logo-company company-logo"></a>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="box light item">
                    ...
                    <a class="btn" href="{$Top.CloudUrl('assets/berlin-summit/Berlin18-Summit-City-Guide-112.pdf')}">Download <i class="fa fa-download"></i></a>
                </div>
