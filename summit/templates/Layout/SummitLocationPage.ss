	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 hotel-block">
				...
				<p>
					<a href="#hotels" onclick="myClick(2);" target="_blank" alt="View On Map"><i class="fa fa-map-marker"></i> Map</a>
					<a href="https://resweb.passkey.com/go/openstack" target="_blank" alt="Visit Website"><i class="fa fa-home"></i> Bookings</a>
				</p>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 hotel-block">
