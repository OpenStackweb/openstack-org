   	...
   	if(!loggedIn && votingOpen) {
   		return (
			  ...
			  <div className="login-to-vote">
			     ...
			     <p>OpenStack community members are voting on presentations to be presented at the OpenStack Summit in Barcelona, Spain. We received hundreds of high-quality submissions, and your votes can help us determine which ones to include in the schedule.</p>
